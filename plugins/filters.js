...
const array = ['Pikachu','Msd','chriz','Vijay','Rashmika','song','Sry','Da','Line']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
