...
const array = ['name entha','Helo','King','Kooi','Tuttu','Azaru','Ramos','Tentacion','chriz','Oompi','oomb','johnwick','bie','Uff','Undachu','Johnwick','loveyou','poda','vichu','cheera','veerappan','😂😂','Ok so','undachu','shani','surya','nenpa','Sed aaki','Poda myre','Achu','Lucky','Spam','m4','maju','Oompi',
